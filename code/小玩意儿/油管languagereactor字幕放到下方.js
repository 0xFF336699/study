...
(function() {
    ...
    function checkChangeParent(visibility){
        ...
        if(visibility == lastLlnVisibility && isTheater == isInTheater){
            return
        }
        if(!bottomParent){
            return;
        ...
        if(lastLlnVisibility == "visible" && isInTheater){
            ...
            if(caption.parentNode != videoCationsShell){
                ...
                caption.setAttribute('style', 'position:relative;background-color:#000000;height:16rem;');
            }
        }else{
            if(caption.parentNode == videoCationsShell){
